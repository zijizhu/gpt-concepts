...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='data/coco/cat2gpt_responses.pkl')
    parser.add_argument('--output_dir', type=str, default='data/coco/cat2concepts.json')
    ...
    with open(args.input_dir, 'rb') as fp:
